  ...
  <div class="container">
    <div class="lin-info">
      <div class="lin-info-left">
        <div class="welcome">
          <div class="subtitle">
            <div class="guide"><p style="font-size: 30px;">ENGF0002</p></div>
            <br />
            <br />
            <div class="link"><p style="font-size: 40px;">TEAM 1</p></div>
          </div>
        </div>
      </div>
      <div class="lin-info-right">
        <div class="team-detail">
          <div class="team-box">
            <ul class="team-ul">
              <li>
                <span class="shadow-box"> <i class="team-shadow"></i> </span> <span class="team-role">Front-end</span>
                <span class="team-name">Chen Yang</span>
              </li>
              <li>
              ...
              <li>
                ...
                <span class="team-name">Jeffrey Li</span>
              </li>
              <li>
                <span class="shadow-box"> <i class="team-shadow"></i> </span> <span class="team-role">Database</span>
                <span class="team-name">Minyi Lei</span>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div class="quantity-item">
        <div class="quantity-detail">
          <div class="quantity-detail-box">
            <div class="quantity-title">20084701</div>
            <div class="quantity-border-line"></div>
            <div class="quantity">Chen Yang</div>
          </div>
        </div>
        <div class="quantity-icon"><img src="../../assets/image/user/Chen.jpg" alt="" /></div>
      </div>
      <div class="quantity-item">
        <div class="quantity-detail">
          <div class="quantity-detail-box">
            <div class="quantity-title">20005893</div>
            <div class="quantity-border-line"></div>
            <div class="quantity">Jeffrey Li</div>
          </div>
        </div>
        <div class="quantity-icon"><img src="../../assets/image/user/Jeffrey.jpg" alt="" /></div>
      </div>
      <div class="quantity-item">
        <div class="quantity-detail">
          <div class="quantity-detail-box">
            <div class="quantity-title">20000859</div>
            <div class="quantity-border-line"></div>
            <div class="quantity">Minyi Lei</div>
          </div>
        </div>
        <div class="quantity-icon"><img src="../../assets/image/user/Minyi.jpg" alt="" /></div>
      </div>
      <div class="quantity-item">
        <div class="quantity-detail">
          <div class="quantity-detail-box">
            <div class="quantity-title">20100587</div>
            <div class="quantity-border-line"></div>
            <div class="quantity">Siqi Zhu</div>
          </div>
        </div>
        <div class="quantity-icon"><img src="../../assets/image/user/Siqi.jpg" alt="" /></div>
      </div>
      <!--    </div>-->
